...
public final class Constants {
    ...
    public static final class ArmConstants {
        ...
        public static final double substationConeAngle = 17.0; // 3:12pm 9.0
        public static final double highAngle = 165.0; // 3:12pm 148
        public static final double cubeHigh = 165.0;

        public static final double midAngle = 176.0;
        public static final double homeAngle = -42.0;
    }
    ...
    public static final class ArmMotorPID {
        ...
        public static final double kG = (.499 / 12);
    ...
    public static final class WristConstants {
        ...
        public static final double highAngle = 70.0; // 3:12pm 148
        public static final double cubeHigh = 80.0;

        public static final double midAngle = 87.0;
        public static final double homeAngle = 33.0;
    ...
    public static final class WristMotorPID {
        ...
        public static final double kI = 0;
        public static final double kD = 0;
        public static final double kG = 0;// (.3 / 12);
        public static double allowableError = 10;
        public final double kPeakOutput = 1.0;
    ...
    public static final class IntakeConstants {
        ...
        public static final double vomitSpeed = -.7;
        public static final double vomitSeconds = .5;

        public static final double intakeCurrent = 50;
    }
    ...
    public static final class Swerve {
        ...
        public static final double rotationMultiplier = .02;
        ...
        public static final double slewRate = 2.5; // .85, .8, .75, .7, .65 etc..
        ...
        public static final double trackWidth = Units.inchesToMeters(20.75); // TODO: This must be tuned to specific
                                                                             // robot
        public static final double wheelBase = Units.inchesToMeters(24.75); // TODO: This must be tuned to specific
                                                                            // robot
        ...
        public static final class Mod0 { // TODO: This must be tuned to specific robot
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(261.65);// Rotation2d.fromDegrees(77.34+180);
        ...
        public static final class Mod1 { // TODO: This must be tuned to specific robot
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(251.19);// Rotation2d.fromDegrees(75.41+180);
            public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID,
                    canCoderID, angleOffset);
        }
        ...
        public static final class Mod2 { // TODO: This must be tuned to specific robot
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(97.11);// Rotation2d.fromDegrees(276.50-180);
            public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID,
                    canCoderID, angleOffset);
        }
        ...
        public static final class Mod3 { // TODO: This must be tuned to specific robot
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(281.95);// Rotation2d.fromDegrees(103.79+180);
            public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID,
                    canCoderID, angleOffset);
        }
    }
