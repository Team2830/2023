...
public class FlippedChargeAndMobility extends SequentialCommandGroup {
        public FlippedChargeAndMobility(Swerve s_Swerve, Arm arm, Intake intake) {
                ...
                Trajectory driveOnCharge = TrajectoryGenerator.generateTrajectory(
                                ...
                                List.of(new Pose2d(Constants.FlippedTranslations.CENTER_CONE1,
                                                Rotation2d.fromDegrees(0)),
                                                new Pose2d(Constants.FlippedTranslations.CHARGE_CENTER,
                                                                Rotation2d.fromDegrees(0)),
                                                new Pose2d(Constants.FlippedTranslations.CHARGE_PAST_CENTER,
                                                                Rotation2d.fromDegrees(0))
                                // Interior Waypoints
                ...
                Trajectory backToCharge = TrajectoryGenerator.generateTrajectory(
                                // Start at the origin facing the +X direction
                                List.of(new Pose2d(Constants.FlippedTranslations.CHARGE_PAST_CENTER,
                                                Rotation2d.fromDegrees(0)),
