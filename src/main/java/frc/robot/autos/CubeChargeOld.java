...
public class CubeChargeOld extends SequentialCommandGroup {
        public CubeChargeOld(Swerve s_Swerve, Arm arm, Intake intake) {
                ...
                SwerveControllerCommand driveOverCharge = new SwerveControllerCommand(
                                driveOnCharge,
                                s_Swerve::getPose,
                ...
                SwerveControllerCommand mobilityToCharge = new SwerveControllerCommand(
                                backToCharge,
                                s_Swerve::getPose,
                                Constants.Swerve.swerveKinematics,
                                new PIDController(Constants.AutoConstants.kPXController, 0, 0),
                ...
                AutoBalance autoChargeBalance = new AutoBalance(s_Swerve);
                ...
                addCommands(
                                ...
                                new ParallelDeadlineGroup(driveOverCharge, armToHome),
                                mobilityToCharge,
                                new WaitCommand(1),
                                autoChargeBalance
