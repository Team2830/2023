...
public class TwoPieceAuto extends SequentialCommandGroup {
        public TwoPieceAuto(Swerve s_Swerve, Arm arm, Intake intake) {
                ...
                Trajectory pickupTrajectory = TrajectoryGenerator.generateTrajectory(
                                ...
                                List.of(new Pose2d(Constants.Translations.INSIDE_CONE1, Rotation2d.fromDegrees(0)),
                                                new Pose2d(Constants.Translations.OLD_COMMUNITY_EXIT,
                                                                Rotation2d.fromDegrees(0)),
                                                // Interior Waypoints
                                                // End 3 meters straight ahead of where we started, facing forward
                                                new Pose2d(Constants.Translations.OLD_FLOOR4,
                                                                Rotation2d.fromDegrees(0))),
                                forwardConfig);
                Trajectory scoreCube = TrajectoryGenerator.generateTrajectory(
                                // Start at the origin facing the +X direction
                                List.of(new Pose2d(Constants.Translations.OLD_FLOOR4, Rotation2d.fromDegrees(0)),
                                                new Pose2d(Constants.Translations.OLD_COMMUNITY_EXIT,
                                                                Rotation2d.fromDegrees(0)),
                                                // Interior Waypoints
                                                // End 3 meters straight ahead of where we started, facing forward
                                                new Pose2d(Constants.Translations.OLD_INSIDE_CUBE,
                                                                Rotation2d.fromDegrees(0))),
                                backwardConfig);
